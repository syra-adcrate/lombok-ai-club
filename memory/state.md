...
- Second-brain structure (`memory/`) created 2026-08-06; surfaced in the dashboard's
  🧠 Second Brain tab ("Workspace memory" section).
- **Xenorita** customer-success agent active since 2026-08-06 (`.claude/agents/xenorita.md`);
  her pipeline lives in `.agents/customer-success/` (currently 5 accounts, all marked test
  data) and renders in the same dashboard tab. AI team roster: `.agents/TEAM.md`.
